 ...
 * тегами сотрудника, как и лидами). Цвет — любой #rrggbb (свободная палитра, §39;
 * пресеты для быстрого выбора — TAG_COLORS в js/lead.js): клиент красит чипы через
 * el.style (CSP это разрешает), мусор сервер сводит к дефолту.
