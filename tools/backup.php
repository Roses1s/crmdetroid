...
// Дамп — небуферизованными запросами: буферизованный SELECT * грузил каждую таблицу
// целиком в память PHP, на больших логах это упиралось в memory_limit (ревью, п. 6.1).
// Запросы ниже строго последовательные (один открытый курсор), поэтому unbuffered безопасен.
