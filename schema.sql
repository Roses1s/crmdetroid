...
CREATE TABLE IF NOT EXISTS crm_lead_apps (
  ...
  load_time_from VARCHAR(5) NOT NULL DEFAULT '',
  load_time_to VARCHAR(5) NOT NULL DEFAULT '',
  ...
  unload_time_from VARCHAR(5) NOT NULL DEFAULT '',
  unload_time_to VARCHAR(5) NOT NULL DEFAULT '',
  PRIMARY KEY (id),
  KEY idx_lead (lead_id),
