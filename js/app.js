'use strict';
/* global $, $$, Loading, Modal, Net, Store, Theme, Toast, _confirmResolver:writable, _promptResolver:writable, appsWord, askConfirm, askPrompt, closeImageLightbox, debounce, esc, fmtBytes, fmtMoney, fmtTime, formatInnInput, formatMarginInput, goNeighborCarrier, isImageAtt, isValidEmail, loadRoutes, moneyNum, moneyToInput, openCarrier, openImageLightbox, openRoute, passwordError, plural, renderCarrierLog, safeAttUrl, saveCarrierDebounced, saveCarrierForm, setRoutesFilter, setupPhoneMask, withLock */
