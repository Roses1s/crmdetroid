'use strict';
/* global $, $$, Loading, Modal, Net, Store, Theme, Toast, _confirmResolver:writable, _promptResolver:writable, askConfirm, askPrompt, closeImageLightbox, debounce, esc, fmtBytes, fmtMoney, fmtTime, formatInnInput, formatMarginInput, isImageAtt, isValidEmail, moneyNum, moneyToInput, openImageLightbox, passwordError, plural, safeAttUrl, setupPhoneMask, withLock */
