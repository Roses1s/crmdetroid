'use strict';
/* global $, $$, Loading, Modal, Net, Store, Theme, Toast, _confirmResolver:writable, _promptResolver:writable, askConfirm, askPrompt, closeImageLightbox, closeLeadAppModal, debounce, deleteLeadApp, editingCommentAttCount, esc, formatInnInput, formatMarginInput, goNeighborCarrier, goNeighborLead, isValidEmail, leadAppsOf, loadLeadComments, loadRoutes, openCarrier, openImageLightbox, openLead, openLeadAppModal, openRoute, passwordError, persistOk, plural, renderBoard, renderCarrierLog, renderFiles, renderLog, resetBoardCache, saveCarrierDebounced, saveCarrierForm, saveLeadAppFromModal, saveLeadDebounced, saveLeadForm, setRoutesFilter, setupPhoneMask, withLock */
/* exported syncAdminNav, updateSearchPlaceholder, usersTableBusy */
