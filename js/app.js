'use strict';
/* global $, $$, Modal, Net, Store, Theme, Toast, _confirmResolver:writable, _promptResolver:writable, activityShiftYear, askConfirm, askPrompt, closeImageLightbox, closeLeadAppModal, confirmDeleteUser, debounce, deleteLeadApp, editingCommentAttCount, esc, formatInnInput, formatMarginInput, goNeighborCarrier, goNeighborLead, isValidEmail, leadAppsOf, loadActivity, loadLeadComments, loadRoutes, loadUsers, openCarrier, openDeleteUser, openImageLightbox, openLead, openLeadAppModal, openRoute, passwordError, persistOk, renderBoard, renderCarrierLog, renderFiles, renderLog, resetBoardCache, saveCarrierDebounced, saveCarrierForm, saveLeadAppFromModal, saveLeadDebounced, saveLeadForm, setActivityUser, setRoutesFilter, setupPhoneMask, withLock */
