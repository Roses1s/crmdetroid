...
const appJs = ['util.js', 'net.js', 'search.js', 'lead.js', 'admin.js', 'routes.js', 'app.js'].map(f => fs.readFileSync(path.join(ROOT, 'js', f), 'utf8')).join('\n;\n')
  + "\n;window.Store=Store;window.Net=Net;window.UI=UI;window.openLead=openLead;window.openApp=openApp;window.loadUsers=loadUsers;window.stopPolling=stopPolling;window.handleHashRouting=handleHashRouting;window.__pollActive=()=>!!pollTimer;";
